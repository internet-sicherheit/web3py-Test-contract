...
+"working_account transaction count: " + str(w3.eth.getTransactionCount(working_account))+ '\n')
...
for x in range(transRange):
    ...
    print("program requires " + str(process.memory_info().rss) + "bytes of memory.")  # in bytes 
    # deactivate for excessive testing
...
#print("Number of Addresses (before sleep): " + str(tester_postDeployment.functions.howManyAddresses().call()) + '\n')
#print("Number of Numbers (before sleep): " + str(tester_postDeployment.functions.howManyNumbers().call()) + '\n')
#time.sleep(120)
#print("Number of Addresses (after sleep): " + str(tester_postDeployment.functions.howManyAddresses().call()) + '\n')
#print("Number of Numbers (after sleep): " + str(tester_postDeployment.functions.howManyNumbers().call()))
